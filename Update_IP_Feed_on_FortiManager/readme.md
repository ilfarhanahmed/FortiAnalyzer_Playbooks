...
- Download the Playbook **Update_IP_Feed_on_FortiManager_v8.json** for **FAZ v8.0** and import the file to **FortiAnalzyer: Incidents & Alerts -> Automation -> Playbook -> More -> Import**.
