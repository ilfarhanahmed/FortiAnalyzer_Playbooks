...
1. Download appropriate (v7.6/8.0) Playbook **Update_IP_Feed_on_FortiManager_vX.X.json** and import the file to **FortiAnalzyer: Incidents & Alerts -> Automation -> Playbook -> More -> Import**.
